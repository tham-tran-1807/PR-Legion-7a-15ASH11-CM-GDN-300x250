...
lib.ssMetadata = [
		{name:"PR_Legion_7a_15ASH11_CM_GDN_300x250_atlas_1", frames: [[906,0,50,50],[0,0,300,250],[302,0,300,250],[0,504,287,216],[604,0,300,250],[302,488,300,207],[604,483,286,222],[302,252,300,234],[0,252,300,250],[604,252,287,229]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_7a_15ASH11_CM_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegion7a15ASH11CMGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(300).to({_off:false},0).to({x:10.35,y:11},12).wait(18));
	...
	this.instance_3.setTransform(14,17);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(199).to({_off:false},0).to({_off:true},51).wait(80));

	// F4
	this.instance_4 = new lib.F4();
	this.instance_4.setTransform(0,43);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(149).to({_off:false},0).to({_off:true},50).wait(131));

	// F3
	this.instance_5 = new lib.F3();
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(99).to({_off:false},0).to({_off:true},50).wait(181));

	// F2
	this.instance_6 = new lib.F2();
	this.instance_6.setTransform(13,14);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(50).to({_off:false},0).to({_off:true},49).wait(231));
...
// library properties:
lib.properties = {
	id: '31DEC016B5F12544B88066D926903F69',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_7a_15ASH11_CM_GDN_300x250_atlas_1.png", id:"PR_Legion_7a_15ASH11_CM_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['31DEC016B5F12544B88066D926903F69'] = {
